...
class GameData:
    def __init__(self) -> None:
        ...
        self.cars = player_data["cars"]
        self.car_data = {}
        for car in player_data["cars"]:
            self.car_data[car] = car_data[car]
        self.money = float(player_data["money"])
        self.time = player_data["time"]
        self.date = player_data["date"]
        self.garageSpaces = player_data["garageSpaces"]
        self.carPos = player_data["carPos"]
